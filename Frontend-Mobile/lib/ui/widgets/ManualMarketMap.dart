      ...
      children: [
                ...
                CircleAvatar(
                  ...
                  child: IconButton(
                    icon: Icon(Icons.arrow_back_ios_new_rounded,
                        size: 20, color: ColorsFrave.primaryColorFrave),
        ...
        Center(
          child: Transform.translate(
              offset: Offset(0, -15),
              child:
                  BounceInDownFrave(child: Icon(Icons.location_on, size: 50))),
        ),
        Positioned(
            bottom: 70,
            left: 40,
              ...
              onPressed: () {
                if (myLocationBloc.state.addressName != '') {
                  Navigator.pushReplacement(
                      context, routeFrave(page: AddStreetAddressPage()));
                }
              },
            ))
      ],
