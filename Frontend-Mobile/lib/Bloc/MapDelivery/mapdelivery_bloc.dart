import 'dart:async';
import 'dart:convert';
import 'package:e_commers/Service/MapBoxController.dart';
...
import 'package:e_commers/ui/themes/ThemeMaps.dart';
...
class MapdeliveryBloc extends Bloc<MapdeliveryEvent, MapdeliveryState> {
  ...
  void initSocketDelivery() {
    this._socket = IO.io(URLS.baseUrl + 'orders-delivery-socket', {
  ...
  Future<void> _onMarkertDelivery(
    ...
    final marketCustom =
        await getAssetImageMarker('assets/delivery-marker.png');
